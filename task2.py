...
train_data = pandd.read_csv("train_data.txt", delimiter='\t')
test_data = pandd.read_csv("test_data.txt", delimiter='\t')
...
output = pandd.DataFrame({'plot': test_data['plot'], 'predicted_genre': test_predictions_labels})
output.to_csv("predicted_genres.txt", index=False)



test_solution = pandd.read_csv("test_data_solution.txt", delimiter='\t')
